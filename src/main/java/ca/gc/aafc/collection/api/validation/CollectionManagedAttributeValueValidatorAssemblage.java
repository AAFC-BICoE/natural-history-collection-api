...
/**
 * For ASSEMBLAGE managed attribute
 */
@Component
public class CollectionManagedAttributeValueValidatorAssemblage extends ManagedAttributeValueValidatorV2<CollectionControlledVocabularyItem> {

  public CollectionManagedAttributeValueValidatorAssemblage(@Named("validationMessageSource")MessageSource messageSource,
  ...
  public String getDinaComponent() {
    return CollectionVocabularyConfiguration.DinaComponent.ASSEMBLAGE.name();
  }
}
