...
/**
 * For SITE managed attribute
 */
@Component
public class CollectionManagedAttributeValueValidatorSite
  extends ManagedAttributeValueValidatorV2<CollectionControlledVocabularyItem> {

  public CollectionManagedAttributeValueValidatorSite(
  ...
  public String getDinaComponent() {
    return CollectionVocabularyConfiguration.DinaComponent.SITE.name();
  }
}
