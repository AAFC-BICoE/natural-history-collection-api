...
/**
 * For ORGANISM managed attribute
 */
@Component
public class CollectionManagedAttributeValueValidatorOrganism extends ManagedAttributeValueValidatorV2<CollectionControlledVocabularyItem> {

  public CollectionManagedAttributeValueValidatorOrganism(@Named("validationMessageSource")MessageSource messageSource,
  ...
  public String getDinaComponent() {
    return CollectionVocabularyConfiguration.DinaComponent.ORGANISM.name();
  }
}
