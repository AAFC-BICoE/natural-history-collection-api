...
/**
 * For PREPARATION managed attribute
 */
@Component
public class CollectionManagedAttributeValueValidatorPreparation extends ManagedAttributeValueValidatorV2<CollectionControlledVocabularyItem> {

  public CollectionManagedAttributeValueValidatorPreparation(@Named("validationMessageSource")MessageSource messageSource,
  ...
  public String getDinaComponent() {
    return CollectionVocabularyConfiguration.DinaComponent.PREPARATION.name();
  }
}
