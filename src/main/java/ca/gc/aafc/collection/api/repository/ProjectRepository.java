...
public class ProjectRepository extends DinaRepositoryV2<ProjectDto, Project> {
  ...
  public ProjectRepository(
    ...
    super(
      ...
      ProjectDto.class,
      Project.class,
      buildProperties, objectMapper, new DinaMappingRegistry(ProjectDto.class, true));
    this.dinaAuthenticatedUser = dinaAuthenticatedUser.orElse(null);
  }

  @Override
  protected Link generateLinkToResource(ProjectDto dto) {
    try {
  ...
  @GetMapping(ProjectDto.TYPENAME + "/{id}")
  public ResponseEntity<RepresentationModel<?>> onFindOne(@PathVariable UUID id, HttpServletRequest req)
    throws ResourceNotFoundException, ResourceGoneException {
    return handleFindOne(id, req);
  }

  @GetMapping(ProjectDto.TYPENAME)
  public ResponseEntity<RepresentationModel<?>> onFindAll(HttpServletRequest req) {
    return handleFindAll(req);
  }

  @PostMapping(path = ProjectDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @PostMapping(ProjectDto.TYPENAME)
  @Transactional
  ...
  @PatchMapping(ProjectDto.TYPENAME + "/{id}")
  @Transactional
  ...
  @PatchMapping(path = ProjectDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(path = ProjectDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(ProjectDto.TYPENAME + "/{id}")
  @Transactional
