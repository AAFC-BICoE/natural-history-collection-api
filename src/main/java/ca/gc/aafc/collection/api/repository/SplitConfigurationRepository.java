...
public class SplitConfigurationRepository extends DinaRepositoryV2<SplitConfigurationDto, SplitConfiguration> {
  ...
  public SplitConfigurationRepository(
    ...
    super(
      ...
      SplitConfigurationMapper.INSTANCE,
  ...
  @Override
  protected Link generateLinkToResource(SplitConfigurationDto dto) {
    try {
      return linkTo(methodOn(SplitConfigurationRepository.class).onFindOne(dto.getUuid(), null)).withSelfRel();
    } catch (ResourceNotFoundException | ResourceGoneException e) {
      throw new RuntimeException(e);
    }
  }

  @PostMapping(path = SplitConfigurationDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_LOAD_PATH, consumes = JSON_API_BULK)
  ...
  @GetMapping(SplitConfigurationDto.TYPENAME + "/{id}")
  public ResponseEntity<RepresentationModel<?>> onFindOne(@PathVariable UUID id, HttpServletRequest req)
      throws ResourceNotFoundException, ResourceGoneException {
    return handleFindOne(id, req);
  }

  @GetMapping(SplitConfigurationDto.TYPENAME)
  public ResponseEntity<RepresentationModel<?>> onFindAll(HttpServletRequest req) {
    return handleFindAll(req);
  }

  @PostMapping(path = SplitConfigurationDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @PostMapping(SplitConfigurationDto.TYPENAME)
  @Transactional
  ...
  @PatchMapping(SplitConfigurationDto.TYPENAME + "/{id}")
  @Transactional
  ...
  @PatchMapping(path = SplitConfigurationDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(path = SplitConfigurationDto.TYPENAME + "/" + DinaRepositoryV2.JSON_API_BULK_PATH, consumes = JSON_API_BULK)
  @Transactional
  ...
  @DeleteMapping(SplitConfigurationDto.TYPENAME + "/{id}")
  @Transactional
